...
Across the three blocks, write a connected narrative of roughly 5-8 complete sentences rather than a section-by-section recap. For Chinese, target about 300-500 Chinese characters; for English, target about 150-250 words; for other languages, use a comparable reading length. Adapt downward when the source is short or supports only one narrow point. Keep the blocks concrete and non-overlapping. Omit missing beats instead of padding the output, repeating a claim to meet a target, or announcing that the source lacks a detail.
